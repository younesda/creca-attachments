    ...
    <div className="h-full flex flex-col overflow-hidden">
      <PageHeader
        ...
        subtitle={`${tasks.length} tâches · ${
          columns[0].tasks.filter(t => t.priorityColor === "danger").length
      ...
      <div className="flex-1 overflow-x-auto p-8 relative z-10">
        ...
        >
          {columns.map(col => (
            <Card
              key={col.id}
              className="w-80 flex flex-col h-full bg-[#121218]/80 border-border/50"
            >
              ...
              <div className="p-3 flex-1 overflow-y-auto space-y-3">
                {col.tasks.map(t => (
                  <div
                    key={t.id}
                    className="bg-card border border-border p-3 rounded-lg hover:border-primary/50 transition-colors group shadow-sm relative"
                  >
                    <button
                    ...
                    >
                      <div
                        className={cn(
                          "mt-0.5 w-5 h-5 rounded flex items-center justify-center border-2 transition-colors shrink-0",
                          t.status === "done"
                      ...
                      <div>
                        <div
                          className={cn(
                            "text-sm font-medium leading-snug mb-2 transition-colors",
                            t.status === "done"
                        ...
                        <div className="flex flex-wrap items-center gap-2 mt-auto">
                          ...
                          <Badge
                            variant={t.priorityColor as any}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Aujourd'hui, Demain..."
            />
          </div>
          ...
          <div className="pt-4 flex justify-end gap-3">
            ...
            <Button type="submit" disabled={addTask.isPending}>
              {addTask.isPending ? "Ajout..." : "Ajouter la tâche"}
            </Button>
          </div>
        </form>
      </Modal>
